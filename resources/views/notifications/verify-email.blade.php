...
<body style="font-family: Inter">
   <section>
       <div class="wrapper" style="height: 100%; max-width:500px; margin: 50px auto; text-align:center">
           ...
           <div class="container">
               <h1 style="color: #010414; font-size: 25px; font-weight: 900; font-weight: bold; text-align: center; margin-top: 40px;">{{ __('notification.confirm_email') }}</h1>
               <h2 style="color: #010414; font-size: 16px; font-weight: bold; font-weight: 400; margin-top: 30px;">{{ __('notification.confirm_click') }}</h2>
               <a href="{{ $url }}" >
