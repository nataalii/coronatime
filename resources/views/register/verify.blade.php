...
<div class=" flex w-full mt-24">
    <button type="submit" class="w-340px h-14 flex lg:w-96 m-auto justify-center content-center rounded-md bg-grn py-2 px-4 font-bold pt-4 text-white shadow-xs focus:outline-none focus:ring-2 ">
